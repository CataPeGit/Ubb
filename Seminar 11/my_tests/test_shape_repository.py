...
class TestShapeRepository(unittest.TestCase):
    ...
    def test_sort_perimeter(self):
        ...
        self.assertEqual(len(self.repo.my_sort_by_perimeter()), 7)
        self.assertEqual(self.repo.my_sort_by_perimeter(), ordered_asc)
        self.assertEqual(len(self.repo.my_sort_by_perimeter(desc=True)), 7)
        self.assertEqual(self.repo.my_sort_by_perimeter(desc=True), ordered_desc)

        self.assertEqual(len(self.repo.in_built_sort_by_perimeter()), 7)
        self.assertEqual(self.repo.in_built_sort_by_perimeter(), ordered_asc)
        self.assertEqual(len(self.repo.in_built_sort_by_perimeter(desc=True)), 7)
        self.assertEqual(self.repo.in_built_sort_by_perimeter(desc=True), ordered_desc)

    def test_sort_shapes_starting_with(self):
        self.assertEqual(len(self.repo.my_sort_by_perimeter_starts_with("test")), 0)
        self.assertEqual(len(self.repo.my_sort_by_perimeter_starts_with("test", desc=True)), 0)
        self.assertEqual(len(self.repo.in_built_sort_by_perimeter_starts_with("test")), 0)
        self.assertEqual(len(self.repo.in_built_sort_by_perimeter_starts_with("test", desc=True)), 0)
        ...
        self.assertEqual(len(self.repo.my_sort_by_perimeter_starts_with("sq")), 3)
        self.assertEqual(self.repo.my_sort_by_perimeter_starts_with("sq"), squares_ordered_asc)
        self.assertEqual(self.repo.my_sort_by_perimeter_starts_with("sq", desc=True), squares_ordered_desc)
        self.assertEqual(len(self.repo.in_built_sort_by_perimeter_starts_with("sq")), 3)
        self.assertEqual(self.repo.in_built_sort_by_perimeter_starts_with("sq"), squares_ordered_asc)
        self.assertEqual(self.repo.in_built_sort_by_perimeter_starts_with("sq", desc=True), squares_ordered_desc)
