...
class ShapeRepository:
    ...
    def __str__(self):
        ...
        str_repr = "Shapes in the repository:\n"
    ...
    def in_built_more_than_k(self, k):
        ...
        @rtype: ShapeRepository
        """
        return ShapeRepository(in_built_filter(self.__shapes, lambda shape: shape.get_number_of_sides() > k))

    def my_higher_perimeter(self, min_perimeter, name_length):
        """
        Seminar 10. iii. 3.
        ...
        @param min_perimeter: minimum value of the perimeter
        @type: int | float
        ...
        @rtype: ShapeRepository
        """
        return ShapeRepository(my_filter(self.__shapes, lambda shape: shape.perimeter() > min_perimeter and len(shape.get_name()) == name_length))

    def in_built_higher_perimeter(self, min_perimeter, name_length):
        """
        Seminar 10. iii. 3.
        Filters shapes from the repository which have perimeter higher than a given value and
        ...
        @rtype: ShapeRepository
        """
        return ShapeRepository(in_built_filter(self.__shapes, lambda shape: shape.perimeter() > min_perimeter and len(shape.get_name()) == name_length))

    def my_sort_by_perimeter(self, desc=False):
        """
    ...
    def in_built_sort_by_perimeter(self, desc=False):
        """
        Sort the shapes in the repository in a new repository based on their parameters
    ...
    def my_sort_by_perimeter_starts_with(self, prefix, desc=False):
        """
        ...
        return ShapeRepository(filtered).my_sort_by_perimeter(desc)

    def in_built_sort_by_perimeter_starts_with(self, prefix, desc=False):
        """
        Sort the shapes which name starts with a given prefix in the repository in a new repository
        ...
        return ShapeRepository(filtered).in_built_sort_by_perimeter(desc)
